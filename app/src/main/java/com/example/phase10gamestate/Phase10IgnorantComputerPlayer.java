...
public class Phase10IgnorantComputerPlayer /*extends blah blah blah*/ {
    ...
    protected void receiveInfo(GameInfo info) {
        ...
        /* PHASE */
        if (!hasPhased) {
            int phasing = checkPhaseReady(copy, phase); //0 if not ready, number of groups if ready
            if (phasing > 0){
                doPhase(phasing); //Phase action in here
                hasPhased = true;
            }
        }
