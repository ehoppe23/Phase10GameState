...
public class PhaseTest {
    ...
    public void checkIfPhaseOne() {
       ...
       // assertTrue(phase.checkIfPhaseOne(sorted,1));
        assertFalse(phase.checkIfPhaseOne(bad,1));;
    ...
    public void checkIfPhaseTwo() {
        ...
        assertTrue(phase.checkIfPhaseTwo(sorted,1));
        assertFalse(phase.checkIfPhaseTwo(notPhase,1));
    ...
    public void checkIfPhaseThree() {
        ...
        assertTrue(phase.checkIfPhaseThree(sorted,1));
        assertFalse(phase.checkIfPhaseThree(notPhase,1));
    }
    ...
    public void checkIfPhaseFive() {
        ...
        assertTrue(phase.checkIfPhaseFive(hand,1));
        assertFalse(phase.checkIfPhaseFive(notRun,1));
    }
    ...
    public void checkIfPhaseSix() {
        ...
        assertTrue(phase.checkIfPhaseSix(hand,1));
        assertFalse(phase.checkIfPhaseSix(notRun,1));
    ...
    public void checkIfPhaseSeven() {
        ...
        Card[] sorted = phase.sortCards(hand);
        Card[] bad = phase.sortCards(notPhase);
        assertTrue(phase.checkIfPhaseSeven(sorted,1));
        assertFalse(phase.checkIfPhaseSeven(bad,1));;
...
//dummy hand to work
       ...
       //dummy hand to fail
        ...
        Card[] sorted = phase.sortCards(hand);
        Card[] bad = phase.sortCards(notPhase);
        assertTrue(phase.checkIfPhaseNine(sorted,1));
        assertFalse(phase.checkIfPhaseNine(bad,1));
    }
    ...
    public void checkIfPhaseTen() {
      ...
      //dummy hand to work
       ...
       //dummy hand to fail
        ...
        Card[] sorted = phase.sortCards(hand);
        Card[] bad = phase.sortCards(notPhase);
        assertTrue(phase.checkIfPhaseTen(sorted,1));
        assertFalse(phase.checkIfPhaseTen(bad,1));
    }
    ...
    public void isColorGroup() {
        ...
        Card[] sorted = phase.sortCards(hand);
        expectedHand = phase.isColorGroup(sorted, 4,1);
